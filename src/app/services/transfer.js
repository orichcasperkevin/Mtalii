  ...
  return (
    <div>
        <div className='p-3 flex justify-end'>
          <Link href="/services/addTransfer" className='bg-secondary-1 text-white rounded-full p-3 '>+ Add transfer service </Link>
        </div>
        <AccomodationFilters/>        
...
export default GroundTransfers;